...
public class TemperatureChart extends Fragment{
 ...
 private static final String TAG = TemperatureChart.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View temperatureChartView = inflater.inflate(R.layout.temperature_fragment, container, false);
        mTemperatureChart = (LineChart)temperatureChartView.findViewById(R.id.temperaturelinechart);
        initSleepStatus();
